          ...
          {selectedUser && (
            <>
              {[
                ...
                <div key={label}>
                  <label className="block mb-1 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                    {label}
                  </label>
                  <p className="text-sm text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-muted/50 rounded-lg px-3 py-2 border border-gray-100 dark:border-border">
                    {value}
                  </p>
                </div>
              ))}
