...
const LoanAging = () => {
    ...
    const [selectedReport, setSelectedReport] = useState("Loan areas aging reports");

    const handleButtonClick = (loanAging: string, path: string) => {
        setSelectedReport(loanAging);
        router.push(path);
    };
    ...
    return (
        <div>
            ...
            <div className="mt-20 bg-gray-100">
                <LoanTable title="Loan Aging"/>
            </div>
        </div>
    );
};

export default LoanAging;
