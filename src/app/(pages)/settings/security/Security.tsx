          ...
          <div className="bg-card shadow-lg rounded-lg border border-border p-6 lg:p-8">
            ...
            <div className="flex items-center justify-between py-3 px-4 rounded-lg border border-border">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div className="w-9 h-5 bg-muted rounded-full peer peer-checked:bg-primary peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white dark:after:bg-card after:rounded-full after:h-4 after:w-4 after:transition-all" />
              </label>
            </div>
