...
const QueryResult: React.FC<OutputResultProps> = ({ tables, joins }) => {
    ...
    return (
        <div className="p-3 sm:p-4 lg:p-6 bg-gray-100 dark:bg-muted w-full rounded-lg shadow-md mt-4 lg:mt-6">
            ...
            <Drawer open={showJson} onClose={() => setShowJson(false)} fadeFromIndex={0}
                ...
                <DrawerContent>
                    ...
                    <DrawerFooter>
                        <DrawerClose>
                            <button className="text-gray-300 dark:text-gray-600 hover:text-white">Close</button>
                        </DrawerClose>
                    </DrawerFooter>
                </DrawerContent>
            </Drawer>
            ...
            <div className="space-y-4">
                <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-700 dark:text-gray-300">Tables</h3>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    {tables.map((table, index) => (
                            <div key={index} className="bg-white dark:bg-card p-3 sm:p-4 rounded-lg shadow-sm">
                            ...
                            <ul className="list-disc ml-4 sm:ml-6 space-y-1">
                                {table.columns.map((column, colIndex) => (
                                    <li key={colIndex} className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="space-y-4 mt-6">
                <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-700 dark:text-gray-300">Joins</h3>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
